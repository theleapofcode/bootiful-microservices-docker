...
public class SiteController {
	...
	@Autowired
	public SiteController(SearchServiceProxy searchServiceProxy, BookingServiceProxy bookingServiceProxy,
	...
	public String greetingSubmit(@ModelAttribute UIData uiData, Model model) {
		List<Flight> flights = searchServiceProxy.search(uiData.getSearchQuery());
	...
	public String searchBookingSubmit(@ModelAttribute UIData uiData, Model model) {
		...
		BookingRecord booking = bookingServiceProxy.getBooking(id);
	...
	public String checkin(@PathVariable String flightNumber, @PathVariable String origin,
